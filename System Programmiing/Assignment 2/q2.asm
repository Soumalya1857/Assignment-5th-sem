...
.stack 400h
.data
message1 db 0AH,0DH,'Enter the binary number: $'
message2 db 0AH,0DH,'Decimal Value is: $'
message3 db 0AH,0DH,'Enter the Decimal number: $'
message4 db 0AH,0DH,'Binary value is: $'
